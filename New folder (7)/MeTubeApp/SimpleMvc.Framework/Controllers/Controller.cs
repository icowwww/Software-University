namespace SimpleMvc.Framework.Controllers
{
    ...
    public abstract class Controller
    {
        ...
        protected virtual void IsAuthenticated()
        {
            if (this.User.IsAuthenticated)
            {
                this.Model.Data["displayType1"] = "none";
                this.Model.Data["displayType2"] = "block";
                this.Model.Data["user"] = User.Name;
            }
            else
            {
                this.Model.Data["displayType1"] = "block";
                this.Model.Data["displayType2"] = "none";
            }
        }
    }
}
