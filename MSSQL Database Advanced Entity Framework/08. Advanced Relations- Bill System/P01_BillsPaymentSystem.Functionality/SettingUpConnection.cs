...
namespace P01_BillsPaymentSystem.Functionality
{
    public static class SettingUpConnection
    {
        public static void SetUp()
        {
            ...
            Console.WriteLine("You can now try writing the command. If you still getting this error. " +
                              "Go to P01_BillsPaymentSystem.Data.Config.Configuration.ConfigurationString" +
                              " and edit the default info.");
        }
    }
}
